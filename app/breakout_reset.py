...
def _compute_simple_mtf_fixed_tp_pct(*, score: float, atr_pct: float, trigger_rvol: float, sl_pct: float) -> Tuple[float, float]:
    ...
    rr_target += _clamp((trigger_rvol - 1.0) * 0.035, -0.04, 0.06)
...
def _dynamic_trade_management_params(
    ...
    *,
    ...
    tp_fixed, rr_target = _compute_simple_mtf_fixed_tp_pct(score=score, atr_pct=atr_pct, trigger_rvol=trigger_rvol, sl_pct=sl_pct)
