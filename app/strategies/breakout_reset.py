...
TRIGGER_MIN_RVOL = 0.55
TRIGGER_CLOSE_POS_LONG_MIN = 0.48
TRIGGER_CLOSE_POS_SHORT_MAX = 0.52
TRIGGER_MAX_RANGE_ATR = 1.55
TRIGGER_MAX_BODY_ATR = 1.08
TRIGGER_MAX_EMA20_EXTENSION_ATR = 1.45
TREND_STACK_MIN_PCT = 0.00055

RETEST_CLOSE_ATR_TOL = 0.18
RETEST_EMA20_TOL_ATR = 0.22
RETEST_CONFIRM_CLOSE_POS_FLEX_LONG = 0.46
